...
public class BatchConfig {
    ...
    @Bean
    public FlatFileItemReader<MatchInputs> reader() {
        return new FlatFileItemReaderBuilder<MatchInputs>()
                .name("matchItemReader")
                .resource(new ClassPathResource("match-data.csv"))
                .delimited()
                .names(FIELD_NAMES)
                .fieldSetMapper(new BeanWrapperFieldSetMapper<MatchInputs>() {
                    {
                        setTargetType(MatchInputs.class);
                    }
                })
                .build();
    }
